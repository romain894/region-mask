...
def main(argv=None):
    ...
    parser.add_argument("--runner", default="regression.runners:module_runner")
    ...
    parser.add_argument("--timeout", type=int, default=1800, help="Per-stage timeout in seconds (legacy runner: per cell)")
