...
The water footprint uses the same repair and country clipping as ocean groups.
"""
...
from .ocean_partition import ocean_domain
...
def generate_land_ocean(countries_from_ne_path, oceans_from_ne_path, codes_id_path, full_path):
    ...
    gdf_ocean.geometry = [ocean_domain(gdf_oceans, gdf_countries)]
